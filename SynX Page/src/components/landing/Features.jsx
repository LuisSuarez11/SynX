...
const VisualAPI = () => {
  return (
    <div className="w-full h-full bg-[#030303] flex items-center justify-center p-6 md:p-8 relative overflow-hidden">
      ...
      />
      <div className="absolute inset-0 bg-[#040508]/70"></div>
      <div className="relative z-10 w-full max-w-md bg-[#040508]/80 border border-[#1E2330] rounded-2xl overflow-hidden shadow-2xl backdrop-blur-xl">
        <div className="flex items-center gap-2 px-4 py-3 border-b border-[#1E2330] bg-white/5">
          <div className="w-3 h-3 rounded-full bg-red-500"></div>
          <div className="w-3 h-3 rounded-full bg-yellow-500"></div>
          <div className="w-3 h-3 rounded-full bg-green-500"></div>
          <span className="ml-2 font-mono-tech text-[10px] text-[#D7DCE8]">api_gateway.log</span>
        </div>
        <div className="p-6 font-mono-tech text-xs md:text-sm text-[#D7DCE8]">
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.5, delay: 0.2 }}>
            <span className="text-[#6D5DF6]">POST</span> /v1/auth/nfc-reader
          </motion.div>
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.5, delay: 0.6 }} className="mt-2 text-[#D7DCE8]/80">
            &#123;
            <br />&nbsp;&nbsp;"device_id": "XR-900",
          ...
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.5, delay: 1.2 }} className="mt-4 flex items-center gap-2">
            ...
            <span className="text-[#D7DCE8]/80">{"->"}
            </span>
            <span className="text-[#F8FAFC]">ACCESS_GRANTED</span>
          </motion.div>
          <motion.div 
            className="w-full h-1 bg-gradient-to-r from-[#6D5DF6] to-transparent mt-6 rounded-full"
...
const VisualDashboard = () => {
  return (
    <div className="w-full h-full bg-[#030303] flex items-end justify-center p-8 md:p-12 relative overflow-hidden">
      ...
      />
      <div className="absolute inset-0 bg-[#040508]/70"></div>
      <div className="absolute top-0 w-full h-full bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-[#3A4C8C]/20 via-black/0 to-black/0"></div>
      <div className="relative z-10 w-full max-w-lg flex items-end gap-3 h-64">
        {[40, 65, 45, 80, 55, 90, 70].map((h, i) => (
          <motion.div
            key={i}
            className="flex-1 bg-gradient-to-t from-[#6D5DF6]/20 to-[#3A4C8C] rounded-t-sm border-t border-[#6D5DF6] shadow-[0_0_15px_rgba(109, 93, 246,0.5)]"
            initial={{ height: 0 }}
            animate={{ height: `${h}%` }}
...
const VisualMobile = () => {
  return (
    <div className="w-full h-full bg-[#030303] flex items-center justify-center relative overflow-hidden">
      ...
      />
      <div className="absolute inset-0 bg-[#040508]/60"></div>
      <motion.div 
        className="absolute w-[500px] h-[500px] border border-[#6D5DF6]/20 rounded-full"
        animate={{ scale: [1, 1.1, 1], opacity: [0.1, 0.3, 0.1] }}
        transition={{ duration: 4, repeat: Infinity }}
      />
      <div className="relative z-10 w-[200px] h-[400px] md:w-[240px] md:h-[480px] bg-[#040508] border-[6px] border-[#1E2330] rounded-[2.5rem] p-4 flex flex-col shadow-2xl">
        <div className="w-20 h-4 bg-[#12151D] absolute top-0 left-1/2 -translate-x-1/2 rounded-b-xl"></div>
        <div className="mt-8 flex-1 flex flex-col gap-4">
          <div className="w-full h-24 bg-white/5 rounded-xl border border-[#1E2330] p-3 relative overflow-hidden">
            <div className="w-16 h-4 bg-[#1E2330] rounded-full mb-2"></div>
            <div className="w-24 h-6 bg-[#6D5DF6]/20 text-[#6D5DF6] rounded-full"></div>
            <motion.div 
          ...
          <motion.div 
            className="w-full h-12 bg-[#6D5DF6]/20 rounded-xl border border-[#6D5DF6]/30 mt-auto flex items-center justify-center"
            whileHover={{ scale: 1.05 }}
          >
            <span className="text-[#6D5DF6] font-mono-tech text-[9px] uppercase tracking-widest">Reservar Clase</span>
          </motion.div>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="w-full h-full bg-[#030303] flex items-center justify-center relative overflow-hidden">
      <img
        ...
        style={{ filter: 'grayscale(70%) brightness(0.1)' }}
      />
      <div className="absolute inset-0 bg-[#040508]/65"></div>
      <div className="relative w-full max-w-md h-full flex items-center justify-center z-10">
        ...
        <motion.div 
          className="w-16 h-16 bg-[#6D5DF6] rounded-2xl flex items-center justify-center z-10 shadow-[0_0_30px_rgba(109, 93, 246,0.5)]"
          animate={{ scale: [1, 1.1, 1] }}
          transition={{ duration: 2, repeat: Infinity }}
        >
          <Database className="text-[#F8FAFC] w-6 h-6" />
        </motion.div>
        <motion.div className="absolute top-[10%] left-[10%] w-10 h-10 bg-[#12151D]/90 border border-[#1E2330] rounded-xl backdrop-blur-sm" animate={{ y: [0, -10, 0] }} transition={{ duration: 3, repeat: Infinity }} />
        <motion.div className="absolute top-[10%] right-[10%] w-10 h-10 bg-[#12151D]/90 border border-[#1E2330] rounded-xl backdrop-blur-sm" animate={{ y: [0, 10, 0] }} transition={{ duration: 4, repeat: Infinity }} />
        <motion.div className="absolute bottom-[10%] left-[10%] w-10 h-10 bg-[#12151D]/90 border border-[#1E2330] rounded-xl backdrop-blur-sm" animate={{ x: [0, -10, 0] }} transition={{ duration: 3.5, repeat: Infinity }} />
        <motion.div className="absolute bottom-[10%] right-[10%] w-10 h-10 bg-[#12151D]/90 border border-[#1E2330] rounded-xl backdrop-blur-sm" animate={{ x: [0, 10, 0] }} transition={{ duration: 2.5, repeat: Infinity }} />
      </div>
    </div>
  );
};
...
export default function Features() {
  ...
  return (
    <section id="core" className="relative bg-[#040508] border-t border-[#1E2330] overflow-hidden pt-24 pb-48">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="mb-24 text-center">
          <div className="inline-flex items-center gap-2 px-3 py-1 bg-[#6D5DF6]/10 border border-[#6D5DF6]/20 rounded-full mb-6">
            ...
            <span className="font-mono-tech text-[10px] text-[#6D5DF6] uppercase tracking-widest">Módulos Core</span>
          </div>
          <h2 className="text-4xl md:text-5xl lg:text-7xl font-black text-[#F8FAFC] tracking-tight leading-tight max-w-4xl mx-auto">
            Software que se adapta a <span className="text-[#6D5DF6]">tu hardware.</span>
          </h2>
        </div>
        ...
        <div className="flex flex-col lg:flex-row gap-12 relative items-start">
          ...
          <div className="lg:w-1/2 py-[10vh] lg:py-[30vh]">
            {directives.map((d, i) => (
              ...
              >
                <span className="font-mono-tech text-[10px] text-[#6D5DF6] mb-4 block uppercase tracking-widest border border-[#6D5DF6]/30 bg-[#6D5DF6]/10 px-3 py-1 rounded-full w-fit">
                  [{d.code}]
                </span>
                <h3 className="text-3xl md:text-4xl lg:text-5xl font-black text-[#F8FAFC] mb-6 leading-tight">{d.title}</h3>
                <p className="text-[#D7DCE8] text-base md:text-lg leading-relaxed max-w-lg">
                  {d.desc}
                </p>
