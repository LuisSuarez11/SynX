...
function SpotlightCard({ children, className = "" }) {
  ...
  return (
    <div
      ...
      className={`relative rounded-3xl border border-white/10 bg-[#050505] overflow-hidden ${className}`}
    >
      <div
      ...
      <div
        ...
        style={{
          opacity,
          background: `radial-gradient(400px circle at ${position.x}px ${position.y}px, rgba(168,85,247,.4), transparent 40%)`,
    ...
    <div className="w-full h-44 relative overflow-hidden">
      ...
      <div className="absolute bottom-0 left-0 w-full p-4 font-mono-tech text-[10px] text-red-500/80">
        <motion.div animate={{ y: [0, -8, 0] }} transition={{ duration: 4, repeat: Infinity }}>
          ...
          <p className="mt-1 text-white/50 animate-pulse">_</p>
        </motion.div>
      </div>
    </div>
  );
  ...
  return (
    <div className="w-full h-44 relative overflow-hidden">
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        <div className="bg-black/80 backdrop-blur border border-red-500/50 px-4 py-2 rounded-full text-red-400 font-mono-tech text-[10px] flex items-center gap-2 shadow-[0_0_15px_rgba(239,68,68,0.3)]">
...
const VisualHardwareLock = () => {
  return (
    <div className="w-full h-44 relative overflow-hidden">
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        <motion.div 
          className="w-16 h-16 bg-slate-900/90 border-2 border-slate-700 rounded-2xl flex items-center justify-center backdrop-blur-sm"
...
const VisualSaaS = () => {
  return (
    <div className="absolute inset-0 w-full h-full overflow-hidden rounded-2xl">
      ...
      />
      <div className="absolute inset-0 bg-gradient-to-br from-purple-950/80 via-black/70 to-black/90"></div>

      <motion.div 
        className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-24 h-24 bg-purple-600 rounded-full flex items-center justify-center shadow-[0_0_50px_rgba(168,85,247,0.5)] z-20"
        animate={{ scale: [1, 1.05, 1] }}
        transition={{ duration: 2, repeat: Infinity }}
      >
        <span className="font-black text-white text-xl tracking-tighter">SYNX</span>
      </motion.div>

      <motion.div 
        className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[300px] h-[300px] border border-purple-500/20 rounded-full z-10"
        animate={{ rotate: 360 }}
        transition={{ duration: 20, repeat: Infinity, ease: "linear" }}
      >
        <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 w-10 h-10 bg-black/80 backdrop-blur border border-purple-500/50 rounded-xl flex items-center justify-center">
          <Users className="w-4 h-4 text-purple-400" />
        </div>
        <div className="absolute bottom-0 left-1/2 -translate-x-1/2 translate-y-1/2 w-10 h-10 bg-black/80 backdrop-blur border border-purple-500/50 rounded-xl flex items-center justify-center">
          <LinkIcon className="w-4 h-4 text-purple-400" />
        </div>
      </motion.div>

      <div className="absolute bottom-6 left-6 bg-black/80 backdrop-blur-md border border-purple-500/30 p-4 rounded-xl flex items-center gap-4 z-30">
        <div className="w-2 h-2 bg-green-500 rounded-full animate-pulse"></div>
        <span className="text-white font-mono-tech text-xs tracking-widest uppercase">Cloud Engine Active</span>
      </div>
    </div>
  );
};
...
export default function ProblemSolution() {
  return (
    <section id="solucion" className="relative bg-black border-t border-white/10 overflow-hidden py-24">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="mb-16 text-center md:text-left">
          <div className="inline-flex items-center gap-2 px-3 py-1 bg-white/5 border border-white/10 rounded-full mb-6">
            ...
            <span className="font-mono-tech text-[10px] text-slate-300 uppercase tracking-widest">Análisis del Problema</span>
          </div>
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-black text-white tracking-tight leading-tight max-w-2xl">
            El software anticuado frena tu <span className="text-slate-500">crecimiento.</span>
          </h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[auto]">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="md:col-span-1">
            <SpotlightCard className="h-full group">
              <div className="p-8 pb-0">
                ...
                <h3 className="text-2xl font-bold text-white mb-3">Descontrol Administrativo</h3>
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.1 }} className="md:col-span-1">
            <SpotlightCard className="h-full group">
              <div className="p-8 pb-0">
                ...
                <h3 className="text-2xl font-bold text-white mb-3">Hacinamiento de Aforo</h3>
                <p className="text-slate-400 text-sm leading-relaxed mb-6">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.2 }} className="md:col-span-1">
            <SpotlightCard className="h-full group">
              <div className="p-8 pb-0">
                ...
                <h3 className="text-2xl font-bold text-white mb-3">Hardware Lock-in</h3>
                <p className="text-slate-400 text-sm leading-relaxed mb-6">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.3 }} className="md:col-span-3">
            <SpotlightCard className="h-full p-8 md:p-12 border-purple-500/30 group">
              <div className="grid md:grid-cols-2 gap-10 items-center h-full">
                <div>
                  <span className="font-mono-tech text-[10px] text-purple-400 mb-4 block uppercase tracking-widest">LA SOLUCIÓN</span>
                  ...
                  <p className="text-slate-300 text-base md:text-lg leading-relaxed mb-8 max-w-lg">
                    ...
                    Automatiza el aforo y recibe el ID del usuario desde <strong className="text-white">cualquier lector NFC o biométrico actual</strong>, validando todo en tiempo real en la nube.
                  </p>
                  <a href="#core" className="inline-flex items-center gap-2 text-purple-400 font-semibold hover:text-purple-300 transition-colors">
